...
import sonsor1Image from "../../Images/SonsorsImages/sponsor1.jpg";
import sponsor2Image from "../../Images/Logo.jpg";
import sonsor3Image from "../../Images/SonsorsImages/sponsor2.jpg";
  ...
  return (
    <div className={classes.mainContainer}>
      {FAKE_DATA.map((sponsor, index) => (
        ...
        >
          <img
            src={sponsor[`sponsor${index + 1}`].image}
            alt={`sponsor${index + 1}`}
